...
const ServiceTemplateFooter = () => {
  ...
  return (
    <section className="hero-area listing-details-wrapper my-2">
      <div className="container">
        ...
        <div className="listing-faq-box mb-50 wow fadeInUp h5">
          <Accordion className="faq-accordian" defaultActiveKey="collapseOne">
            <div className="card">
              <Accordion.Toggle
                as="a"
          ...
          <Accordion className="faq-accordian" defaultActiveKey="collapseTwo">
            <div className="card">
              <Accordion.Toggle
                as="a"
                className="card-header"
          ...
          <Accordion className="faq-accordian" defaultActiveKey="collapseThree">
            <div className="card">
              <Accordion.Toggle
                as="a"
                className="card-header"
          ...
          <Accordion className="faq-accordian" defaultActiveKey="collapseFour">
            <div className="card">
              <Accordion.Toggle
                as="a"
                className="card-header"
